...
if ( !function_exists( 'parkivia_trx_addons_add_theme_vars' ) ) {
	add_filter( 'parkivia_filter_add_theme_vars', 'parkivia_trx_addons_add_theme_vars', 10, 2 );
	function parkivia_trx_addons_add_theme_vars($rez, $vars) {
...
if (!function_exists('parkivia_trx_addons_get_css')) {
	add_filter('parkivia_filter_get_css', 'parkivia_trx_addons_get_css', 10, 2);
	function parkivia_trx_addons_get_css($css, $args) {
