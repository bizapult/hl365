...
if (!function_exists('parkivia_mailchimp_get_css')) {
	add_filter('parkivia_filter_get_css', 'parkivia_mailchimp_get_css', 10, 2);
	function parkivia_mailchimp_get_css($css, $args) {
