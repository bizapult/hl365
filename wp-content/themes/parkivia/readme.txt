...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Parkivia'.
Please install and activate it before starting to use the theme Parkivia.
Also the theme supports many popular plugins such as 'Revolution Slider', 'WPBakery Page Builder'
and many more.


III. Documentation

Theme documentation is available on http://parkivia.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Parkivia is Fontello.
