...
*/
	...
	// Validate Login form
	jQuery('form.trx_addons_popup_form_login:not(.inited_validation)').addClass('inited_validation').submit(function(e){
	...
	jQuery('form.trx_addons_popup_form_register:not(.inited_validation)').addClass('inited_validation').submit(function(e){
