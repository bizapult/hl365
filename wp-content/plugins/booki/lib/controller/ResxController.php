...
class Booki_ResxController extends Booki_BaseController{
	...
	protected function process($id = -1) {
		...
		$resx->BOOKING_WIZARD_QUANTITY_ELEMENT_REQUIRED = $this->getStringPostValue('BOOKING_WIZARD_QUANTITY_ELEMENT_REQUIRED');
		$resx->BOOKING_WIZARD_SEAT_REQUIRED = $this->getStringPostValue('BOOKING_WIZARD_SEAT_REQUIRED');
