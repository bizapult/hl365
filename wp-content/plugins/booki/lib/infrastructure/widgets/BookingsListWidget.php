...
class Booki_BookingsListWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$this->options = array(
			'widget'=>true
			, 'tags'=>$instance['tags']
			, 'dispalyAllResultsByDefault'=>$instance['displayallresultsbydefault']
	...
	function update( $newInstance, $oldInstance ) {
		...
		$instance['displayallresultsbydefault'] = $newInstance['displayallresultsbydefault'];
	...
	function form( $instance ) {
		$defaults = array(
			'tags'=>''
			, 'displayallresultsbydefault'=>true
		...
		<p>
			<input type="checkbox" id="<?php echo $this->get_field_id( 'displayallresultsbydefault' ); ?>"  
				name="<?php echo $this->get_field_name( 'displayallresultsbydefault' ); ?>" 
				value="<?php echo $instance['displayallresultsbydefault']?>" <?php checked($instance['displayallresultsbydefault']) ?> />
				<label for="<?php echo $this->get_field_id( 'displayallresultsbydefault' ); ?>"><?php _e('Display all results by default', 'booki'); ?></label> 
		</p>
	<?php
	}
}