...
class Booki_SettingGlobal extends Booki_EntityBase{
	...
	public $autoApproveAfterBillingSettlement = false;
	public $registerUserAfterPayment = true;
	public $enableBookMoreButton = true;
	...
	public function displayTimezone(){
		return $this->autoTimezoneDetection;
	}
}
?>