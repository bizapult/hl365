...
class Booki_Resx extends Booki_EntityBase{
	...
	public $BOOKING_WIZARD_QUANTITY_ELEMENT_REQUIRED;
	public $BOOKING_WIZARD_SEAT_REQUIRED;
	...
	public $BOOKING_WIZARD_SEAT_REQUIRED_LOC;
	public $BOOKING_WIZARD_QUANTITY_ELEMENT_REQUIRED_LOC;
	...
	public function __construct(){
		...
		$this->GOT_DISCOUNT = __('You have a %d%% discount!');
		...
		$this->QUANTITY_ELEMENT = __('Quantity', 'booki');
		...
		$this->BOOKING_WIZARD_SEAT_REQUIRED = __('Seats are exhausted. Try selecting a different day.', 'booki');
		$this->BOOKING_WIZARD_QUANTITY_ELEMENT_REQUIRED = __('The last date you tried to book requires additional components that are exhausted. Try selecting a different day.', 'booki');
	...
	public function init(){
		...
		$this->QUANTITY_ELEMENT_LOC = Booki_WPMLHelper::t('quantity_element', $this->QUANTITY_ELEMENT);
		...
		$this->BOOKING_WIZARD_QUANTITY_ELEMENT_REQUIRED_LOC = Booki_WPMLHelper::t('booking_wizard_quantity_element_required', $this->BOOKING_WIZARD_QUANTITY_ELEMENT_REQUIRED);
		$this->BOOKING_WIZARD_SEAT_REQUIRED_LOC = Booki_WPMLHelper::t('booking_wizard_seat_required', $this->BOOKING_WIZARD_SEAT_REQUIRED);
	...
	protected function registerWPML(){
		...
		Booki_WPMLHelper::register('quantity_element', $this->QUANTITY_ELEMENT);
		...
		Booki_WPMLHelper::register('booking_wizard_quantity_element_required', $this->BOOKING_WIZARD_QUANTITY_ELEMENT_REQUIRED);
		Booki_WPMLHelper::register('booking_wizard_seat_required', $this->BOOKING_WIZARD_SEAT_REQUIRED);
	...
	protected function unregisterWPML(){
		...
		Booki_WPMLHelper::unregister('quantity_element');
		...
		Booki_WPMLHelper::unregister('booking_wizard_quantity_element_required');
		Booki_WPMLHelper::unregister('booking_wizard_seat_required');
