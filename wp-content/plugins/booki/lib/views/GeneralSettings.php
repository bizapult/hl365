...
class Booki_GeneralSettings{
	...
	public function __construct(){
		...
		// Booki_SettingsGlobalController initiated in admin action.
	...
	protected function render(){
		...
		if($this->setting->theme === '-1'){
			...
			$calendarThemeRoot = get_stylesheet_directory() . '/booki/' . $this->setting->theme . '/assets/css/jquery-ui/';
		}
		...
		$calendarThemesExternal = $this->getThemes(array('None'=>''), $calendarThemeRoot);
...
<div class="booki">
	...
	<div class="booki col-lg-12">
		<h1><?php echo __('General Settings', 'booki') ?></h1>
	...
	<div class="booki col-lg-12">
		<div class="booki-content-box">
			<form class="form-horizontal" id="generalsettings" data-parsley-validate action="<?php echo admin_url() . "admin.php?page=booki/generalsettings.php" ?>" method="post">
				<input type="hidden" name="controller" value="booki_globalsettings" />
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" href="#timesettings">
								<?php echo __('Timezone, Date Format Settings', 'booki') ?>
							</a>
						</h4>
					</div>
					<div id="timesettings" class="panel-collapse collapse out">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" href="#cartsettings">
								<?php echo __('Cart Settings', 'booki') ?>
							</a>
						</h4>
					</div>
					<div id="cartsettings" class="panel-collapse collapse out">
						<div class="panel-body">
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
							...
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
										<h4><?php echo __('Enable book more button', 'booki') ?></h4>
										<p><?php echo __('When checked, a "Book more" button is displayed in the cart page. This allows the customer to go back from where they came and book again.', 'booki') ?> </p>
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
								   <label class="checkbox">
										<input name="enableBookMoreButton" type="checkbox" <?php echo $_Booki_GeneralSettings->setting->enableBookMoreButton ? "checked" : ""?> /> 
										<?php echo __('Enable book more button', 'booki')?>
									</label>
								</div>
							</div>
							<div class="form-group">
							...
							*/?>
							...
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
										<h4><?php echo __('Auto register user after payment', 'booki') ?></h4>
										<p><?php echo __('When checked, customer is registered in your WordPress instance using their Email, Firstname and Lastname returned from PayPal after payment. This is useful if you have membership disabled and want paying users to be registered. Registered users get order history page.', 'booki') ?> </p>
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
								   <label class="checkbox">
										<input name="registerUserAfterPayment" type="checkbox" <?php echo $_Booki_GeneralSettings->setting->registerUserAfterPayment ? "checked" : ""?> /> 
										<?php echo __('Auto register user after payment', 'booki')?>
									</label>
								</div>
							</div>
						</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" href="#notificationsettings">
								<?php echo __('Notifications, Confirmations and Invoices', 'booki') ?>
							</a>
						</h4>
					</div>
					<div id="notificationsettings" class="panel-collapse collapse out">
						<div class="panel-body">
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
										<h4><?php echo __('Auto confirm payment', 'booki') ?></h4>
										<p><?php echo __('Auto confirms payment after buyer is redirected from Paypal. If you leave this unchecked, buyer needs to 
										re-confirm purchase after being redirected from Paypal i.e. just like on ebay, a two-step process.', 'booki') ?> </p>
									</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
										<h4><?php echo __('Confirm booking automatically after bill settlement', 'booki') ?></h4>
										<p><?php echo __('This is useful if you want to handle booking invoices manually. When checked, bookings are approved and confirmed automatically after bill on invoice is settled through PayPal link found on invoice. When using this option, make sure [Approve and send confirmation email automatically after checkout or payment] is unchecked as they are mutually exclusive.', 'booki') ?> </p>
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
								   <label class="checkbox">
										<input name="autoApproveAfterBillingSettlement" type="checkbox" <?php echo $_Booki_GeneralSettings->setting->autoApproveAfterBillingSettlement ? "checked" : ""?> /> 
										<?php echo __('Approve and send confirmation email automatically after bill settlement', 'booki')?>
									</label>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
										...
										<p><?php echo __('Every booking made needs an owner. When a booking is made anonymously, without user login, i.e. 
										when membership is not required, the default owner of this booking will be the user you set here until you later associate a user to the booking.', 'booki') ?> </p>
									</div>
								</div>
							</div>
							<div class="form-group">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" href="#discountsettings">
								<?php echo __('Discounts', 'booki') ?>
							</a>
						</h4>
					</div>
					<div id="discountsettings" class="panel-collapse collapse out">
						<div class="panel-body">
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" href="#themesettings">
								<?php echo __('Theme Options', 'booki') ?>
							</a>
						</h4>
					</div>
					<div id="themesettings" class="panel-collapse collapse out">
						<div class="panel-body">
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" href="#maintenancesettings">
								<?php echo __('Maintenance Options', 'booki') ?>
							</a>
						</h4>
					</div>
					<div id="maintenancesettings" class="panel-collapse collapse out">
						<div class="panel-body">
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
										<h4><?php echo __('Clear Event log', 'booki') ?></h4>
										<p><?php echo __('The event log contains unexpected error messages due to Email, MailChimp or PayPal failures. 
										There is no reason to keep these messages for longer than necessary. By default, it will be cleared every 7 days. 
										A value of zero has no effect and event log messages will never be cleared automatically.', 'booki') ?> </p>
									</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
										<h4><?php echo __('Reference Parsley JavaScript include', 'booki') ?></h4>
										<p><?php echo __('When checked, Parsley JavaScript include is referenced. 
												The booking system depends on this, so unless your theme or a secondary plugin already references parsley, do not uncheck.', 'booki') ?> </p>
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
								   <label class="checkbox">
										<input name="refParsleyJS" type="checkbox" <?php echo $_Booki_GeneralSettings->setting->refParsleyJS ? "checked" : ""?> /> 
										<?php echo __('Reference Parsley JavaScript include', 'booki')?>
									</label>
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
										<h4><?php echo __('Reference Moment JavaScript include', 'booki') ?></h4>
										<p><?php echo __('When checked, Moment JavaScript include is referenced. 
												The booking system depends on this, so unless your theme or a secondary plugin already references moment, do not uncheck.', 'booki') ?> </p>
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
								   <label class="checkbox">
										<input name="refMomentJS" type="checkbox" <?php echo $_Booki_GeneralSettings->setting->refMomentJS ? "checked" : ""?> /> 
										<?php echo __('Reference Moment JavaScript include', 'booki')?>
									</label>
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
										<h4><?php echo __('Enable responsive features', 'booki') ?></h4>
										<p><?php echo __('Turn on responsive CSS by including the proper viewport meta tag (width=device-width, initial-scale=1.0) within the head element of your page. If your theme is already adding this or you do not want this setting, you may deactivate it from here.', 'booki') ?> </p>
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
								   <label class="checkbox">
										<input name="enableMobileInitialScale" type="checkbox" <?php echo $_Booki_GeneralSettings->setting->enableMobileInitialScale ? "checked" : ""?> /> 
										<?php echo __('Enable responsive features', 'booki')?>
									</label>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
										<h4><?php echo __('Custom pages', 'booki') ?></h4>
										<p><?php echo __('Booki generates a bunch of custom pages it needs for various operations. If you accidentally deleted some of these pages or all, you can use the button below to regenerate all pages all over again.', 'booki') ?> </p>
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<button type="submit" name="booki_regenerate_custompages" class="btn btn-danger"><?php echo __('Regenerate custom pages', 'booki')?></button>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" href="#miscsettings">
								<?php echo __('Misc Options', 'booki') ?>
							</a>
						</h4>
					</div>
					<div id="miscsettings" class="panel-collapse collapse out">
						<div class="panel-body">
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
							...
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
										<h4><?php echo __('Automatic booking cancellation', 'booki') ?></h4>
										<p><?php echo __('The duration a booking is still 
												from the time it was made. Unpaid bookings will be automatically purged out of the system after expiry. 
												A value of zero (the default) has no effect and unpaid bookings will not expire.', 'booki') ?> </p>
									</div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-4 control-label" for="unpaidOrderExpiry">
									<?php echo __('Automatic booking cancellation', 'booki') ?>
								</label>
								<div class="col-lg-8">
									<div class="input-group">
										<input id="unpaidOrderExpiry"
												...
												data-parsley-errors-container=".unpaid-order-expiry-error-container"
												value="<?php echo $_Booki_GeneralSettings->setting->unpaidOrderExpiry?>" />
										 <div class="input-group-btn">
											<select name="orderExpiryMode" id="orderExpiryMode" class="form-control booki-input-group-select">
												<option value="0" <?php echo $_Booki_GeneralSettings->setting->orderExpiryMode === 0 ? "selected" : ""?>><?php echo __('Day', 'booki') ?></option>
												<option value="1" <?php echo $_Booki_GeneralSettings->setting->orderExpiryMode === 1 ? "selected" : ""?>><?php echo __('Week', 'booki') ?></option>
												<option value="2" <?php echo $_Booki_GeneralSettings->setting->orderExpiryMode === 2 ? "selected" : ""?>><?php echo __('Hour', 'booki') ?></option>
												<option value="3" <?php echo $_Booki_GeneralSettings->setting->orderExpiryMode === 3 ? "selected" : ""?>><?php echo __('Minute', 'booki') ?></option>
												<option value="4" <?php echo $_Booki_GeneralSettings->setting->orderExpiryMode === 4 ? "selected" : ""?>><?php echo __('Second', 'booki') ?></option>
											</select>
										 </div>
									</div>
									<div class="unpaid-order-expiry-error-container"></div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
							...
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<div class="booki-callout booki-callout-info">
										<h4><?php echo __('Enable PayPal for billing, if disabled in cart', 'booki') ?></h4>
										<p><?php echo __('When checked, PayPal will be enabled for billing even if you have disabled PayPal in the cart settings. This allows you to still collect payment via PayPal by manually issuing an invoice.', 'booki') ?> </p>
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
								   <label class="checkbox">
										<input name="enablePayPalBilling" type="checkbox" <?php echo $_Booki_GeneralSettings->setting->enablePayPalBilling ? "checked" : ""?> /> 
										<?php echo __('Enable PayPal for billing, if disabled in cart', 'booki')?>
									</label>
								</div>
							</div>
						</div>
