...
<div class="booki">
	...
	<div class="booki col-lg-12">
		<div class="booki-content-box">
			...
			<div class="form-group booki-vertical-gap">
	...
	<div class="booki col-lg-12">
		<div class="booki-content-box">
			...
			<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post" data-parsley-validate>
					...
					<div class="col-lg-8 col-lg-offset-4">
						<div class="form-inline">
							<div class="form-group">
								<div class="radio">
									<label>
										<input type="radio" name="pageindex" data-parsley-ui-enabled="false" value="-1" checked>
										<?php echo __('Export all users', 'booki') ?>
									</label>
								</div>
							</div>
							<div class="form-group">
								<div class="radio">
									<label>
									  <input type="radio" name="pageindex" data-parsley-ui-enabled="false" value="<?php echo $_Booki_Users->pageIndex ?>">
									   <?php echo __('Export the current records only', 'booki') ?>
									</label>
								</div>
							</div>
						</div>
				...
				<div class="form-horizontal">
					<div class="form-group">
						<div class="col-lg-8 col-lg-offset-4">
							<div class="booki-callout booki-callout-info">
								<h4><?php echo __('Mailing list', 'booki') ?></h4>
								<p>
									<?php echo __('Select a MailChimp mailing list to export users, along with coupons you generate using the options below.', 'booki') ?>
								</p>
							</div>
						</div>
					</div>
					...
					<?php if(!$_Booki_Users->mailingList): ?>
						<div class="form-group">
							<div class="col-lg-8 col-lg-offset-4">
								<div class="bg-warning booki-bg-box">
									<strong><?php echo __('Note', 'booki') ?></strong>: <?php echo __('To export to MailChimp you need to first load the mailing list and select a list. 
									Already done ? Then double check your MailChimp API Key (General settings).', 'booki') ?>
								</div>
							</div>
						</div>
					<?php else: ?>
								...
								<div class="form-group">
									<div class="col-lg-8 col-lg-offset-4">
										<div class="booki-callout booki-callout-info">
											...
											<p>
												<?php echo __('A discount value greater than 0 must be provided, otherwise no coupons are generated.', 'booki') ?>
											</p>
										</div>
									</div>
								</div>
...
<script type="text/javascript">
	jQuery(document).ready(function($){
		...
		$('select[name="timezone"]').change(function(){
			var redirectUrl = "<?php echo esc_url(remove_query_arg('timezone')) ?>";
