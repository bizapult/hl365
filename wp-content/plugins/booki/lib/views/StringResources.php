...
<div class="booki">
	...
	<div class="booki col-lg-12">
		<h1><?php echo __('Edit string resources in the booking form', 'booki') ?></h1>
	...
	<div class="booki col-lg-12">
		<div class="booki-content-box">
			<form class="form-horizontal" id="generalsettings" data-parsley-validate action="<?php echo admin_url() . "admin.php?page=booki/stringresources.php" ?>" method="post">
				<input type="hidden" name="controller" value="booki_resx" />
				...
				<div class="form-group">
					<div class="col-lg-12">
						<input type="text" 
							class="booki_parsley_validated form-control"  
							data-parsley-trigger="change" 
							id="BOOKING_WIZARD_SEAT_REQUIRED"
							name="BOOKING_WIZARD_SEAT_REQUIRED" value="<?php echo $_Booki_StringResources->resx->BOOKING_WIZARD_SEAT_REQUIRED ?>"/> 
					</div>
				</div>
				<div class="form-group">
					<div class="col-lg-12">
						<input type="text" 
							class="booki_parsley_validated form-control"  
							data-parsley-trigger="change" 
							id="BOOKING_WIZARD_QUANTITY_ELEMENT_REQUIRED"
							name="BOOKING_WIZARD_QUANTITY_ELEMENT_REQUIRED" value="<?php echo $_Booki_StringResources->resx->BOOKING_WIZARD_QUANTITY_ELEMENT_REQUIRED ?>"/> 
					</div>
				</div>
				<div class="form-group">
					<div class="col-lg-12">
