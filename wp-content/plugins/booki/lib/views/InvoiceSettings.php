...
<div class="booki">
	...
	<div class="booki col-lg-12">
		<h1><?php echo __('Invoice settings', 'booki') ?></h1>
			...
			<form class="form-horizontal" id="invoicesettings" data-parsley-validate action="<?php echo admin_url() . "admin.php?page=booki/invoicesettings.php" ?>" method="post">
				...
				<div class="form-group">
					<div class="col-lg-8 col-lg-offset-4">
						...
						<?php echo __('These settings go in the PDF document which is hyper linked to in the invoice email. To change the message in the email, use the email settings page by selecting "invoice" in the template list.', 'booki') ?>
						</div>
					</div>
				</div>
				<?php endif; ?>
