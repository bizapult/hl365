<div class="booki">
	...
	<div class="booki col-lg-12">
		<div class="booki-callout booki-callout-info">
			...
			<p><?php echo $_Booki_StatsTmpl->hasFullControl ? __('A brief overview of your bookings.', 'booki') : __('A brief overview of bookings approved by you.', 'booki')?> </p>
		</div>
	</div>
	<div class="booki col-lg-12">
	...
	<div class="booki col-lg-12">
		<div class="booki-content-box">
			...
			<div class="col-lg-5 booki-stats-block booki-stats-separator-equal-height">
				<h1 class="badge"><?php echo Booki_Helper::formatCurrencySymbol(Booki_Helper::toMoney((int)$_Booki_StatsTmpl->totalAmountEarned), true);?></h1>
			...
			<div class="col-lg-4 booki-stats-block">
				<h1 class="badge"><?php echo Booki_Helper::formatCurrencySymbol(Booki_Helper::toMoney((int)$_Booki_StatsTmpl->summary->discount), true); ?></h1>
	...
	<form class="form-horizontal" data-parsley-validate action="<?php echo admin_url() . "admin.php?page=booki/stats.php" ?>" method="post">
		...
		<div class="booki col-lg-12">
			<div class="booki-content-box">
				<div class="booki-callout booki-callout-default">
					<h4><?php echo __('Bookings', 'booki')?></h4>
					<p><?php echo $_Booki_StatsTmpl->hasFullControl ? __('Bookings made in the last 3 months', 'booki') : __('Bookings you approved in the last 3 months', 'booki')?></p>
				</div>
				<div class="table-responsive">
		...
		<div class="booki col-lg-12">
			<div class="booki-content-box">
				<div class="booki-callout booki-callout-info">
					...
					<p><?php echo $_Booki_StatsTmpl->hasFullControl ? __('Sales in the last 3 months', 'booki') : __('Sales of bookings you approved in the last 3 months', 'booki')?></p>
				</div>
				<div>
		...
		<div class="booki col-lg-12">
			<div class="booki-content-box">
				<div class="booki-callout booki-callout-danger">
					...
					<p><?php echo $_Booki_StatsTmpl->hasFullControl ? __('Refunds in the last 3 months', 'booki') : __('Refunded bookings you approved in the last 3 months', 'booki')?></p>
				</div>
				<div class="table-responsive">
